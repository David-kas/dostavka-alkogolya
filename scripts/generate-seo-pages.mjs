...
const BASE = 'https://dostavka-alkogolya24.online';

const PHONE_DISPLAY = '+7 (999) 786-39-67';
const PHONE_TEL = '+79997863967';
const LASTMOD = new Date().toISOString().slice(0, 10);
const WA_PREFILL = encodeURIComponent('Здравствуйте! Заказ Алко 24 Онлайн, адрес: ');
...
function raionIntro(name, slug) {
  ...
  const parts = [
    ...
    `Район ${n} входит в зону доставки Алко 24 Онлайн по Москве. Позвоните или напишите в мессенджер — подберём напитки под бюджет и подскажем, сколько ждать курьера с учётом пробок.`,
...
<header class="header site-header">
  ...
  <div class="container header-main-row">
    <a href="/" class="logo">Алко 24 Онлайн</a>
...
<a href="tel:${PHONE_TEL}" class="mobile-tel-fab mobile-tel-fab--secondary" title="Позвонить" aria-label="Позвонить в Алко 24 Онлайн"><span class="visually-hidden">Телефон</span>☎</a>
...
function footerHtml() {
  return `<footer class="footer"><div class="container">
    <p>© 2026 Алко 24 Онлайн. Доставка алкоголя в Москве. <strong>18+</strong></p>
...
function main() {
  ...
  for (const v of VOPROSY) {
    ...
    const title = `${v.q} — Москва 24/7, 20–40 мин ☎ ${PHONE_DISPLAY} | Алко 24 Онлайн`;
  ...
  writeFile(
    ...
    wrapPage({
      title: 'Вопросы о доставке алкоголя Москва 24/7 ☎ ' + PHONE_DISPLAY + ' | Алко 24 Онлайн',
